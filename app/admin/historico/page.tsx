...
const actionText: Record<string, string> = {
  ...
  LEAVE_CANCELLED_BY_DIRECTOR: "Diretor cancelou a folga diretamente",
  LEAVE_DATE_CHANGED_BY_DIRECTOR: "Diretor mudou a data da folga",
  LEAVE_ASSIGNED_BY_DIRECTOR: "Diretor atribuiu a folga",
  EMPLOYEE_REACTIVATED: "Diretor reativou o funcionário",
  EMPLOYEE_PASSWORD_RESET: "Diretor redefiniu a senha",
